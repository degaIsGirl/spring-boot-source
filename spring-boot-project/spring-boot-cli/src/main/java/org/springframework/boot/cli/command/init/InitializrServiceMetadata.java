...
/**
 * Define the metadata available for a particular services instance.
 *
...
class InitializrServiceMetadata {
	...
	/**
	 * Return the dependencies supported by the services.
	...
	/**
	 * Return the project types supported by the services.
	...
	/**
	 * Returns the defaults applicable to the services.
	 * @return the defaults of the services
	 */
