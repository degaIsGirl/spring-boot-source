...
/**
 * A helper class generating a report from the meta-data of a particular services.
 *
...
class ServiceCapabilitiesReportGenerator {
	 ...
	 * @param initializrService the initializr services
	 */
	...
	/**
	 * Generate a report for the specified services. The report contains the available
	 * capabilities as advertised by the root endpoint.
	 * @param url the url of the services
	 * @return the report that describes the services
