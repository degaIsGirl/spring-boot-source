...
public class StopMojo extends AbstractMojo {
	...
	/**
	 * The JMX name of the automatically deployed MBean managing the ioc of the
	 * application.
	 */
	@Parameter
	...
	private void doStop(MBeanServerConnection connection) throws IOException, MojoExecutionException {
		try {
			...
			throw new MojoExecutionException("Spring application ioc JMX bean not found (fork is " + this.fork
